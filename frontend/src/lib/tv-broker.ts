...
export function createBroker(
  ...
  // the broker. Returns "" for stocks/crypto (Alpaca path); "cfd" short-
  // circuits all Alpaca polling — the CFD silo's order/position UI lives
  // in CfdDiscoverPage, not the TV account manager.
