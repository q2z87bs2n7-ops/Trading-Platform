  ...
  return {
    ...
    accountManagerInfo() {
      return {
        ...
        summary: [
          { label: "Equity", property: "equity", formatter: "formatPrice", dataFields: ["equity"] },
          { label: "Buying Power", property: "buyingPower", formatter: "formatPrice", dataFields: ["buyingPower"] },
        ],
        orderColumns: [
          { label: "Symbol", property: "symbol", formatter: "symbol", dataFields: ["symbol"] },
          { label: "Side",   property: "side",   formatter: "side", dataFields: ["side"] },
          { label: "Type",   property: "type",   formatter: "type", dataFields: ["type"] },
          { label: "Qty",    property: "qty",    formatter: "formatQuantity", dataFields: ["qty"] },
          { label: "Status", property: "status", formatter: "status", dataFields: ["status"] },
        ],
        positionColumns: [
          { label: "Symbol",     property: "symbol",       formatter: "symbol", dataFields: ["symbol"] },
          { label: "Qty",        property: "qty",          formatter: "formatQuantity", dataFields: ["qty"] },
          { label: "Avg Price",  property: "avgPrice",     formatter: "formatPrice", dataFields: ["avgPrice"] },
          { label: "Unreal P/L", property: "unrealizedPL", formatter: "profit", dataFields: ["unrealizedPL"] },
        ],
        historyColumns: [
          { label: "Symbol", property: "symbol", formatter: "symbol", dataFields: ["symbol"] },
          { label: "Side",   property: "side",   formatter: "side", dataFields: ["side"] },
          { label: "Qty",    property: "qty",    formatter: "formatQuantity", dataFields: ["qty"] },
          { label: "Price",  property: "price",  formatter: "formatPrice", dataFields: ["price"] },
        ],
        tradeColumns: [],
      };
    },
